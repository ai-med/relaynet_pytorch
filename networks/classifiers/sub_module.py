...
class BasicBlock(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.conv = nn.Conv2d(params['num_channels'], params['num_filters'], (params['kernel_h'], params['kernel_w']),
...
class DecoderBlock(BasicBlock):
    ...
    def forward(self, input, out_block, indices):
        ...
        out_block = super(BasicBlock, self).forward(concat)
...
class ClassifierBlock(nn.Module):
    def __init__(self, params):
        ...
        self.conv = nn.Conv2d(params['num_channels'], params['num_class'], params['kernel'], params['stride_conv'])
